...
if __name__ == "__main__":
    print("Opening Session-2")
    command = r'"C:\Program Files\Google\Chrome\Application\chrome.exe" --remote-debugging-port=9223 --user-data-dir="C:/Chrome_Session2"'
    ...
    local_csv_path = r'C:\Users\Xcient\Desktop\scrapper\1_lac\final_lac_api\100k-leads\9223\temp.csv'  # Set the full path to the local CSV
