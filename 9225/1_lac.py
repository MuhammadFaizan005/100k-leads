...
def open_tabs_and_fetch_product_info(product, df, local_csv_path):
    options = Options()
    options.add_experimental_option("debuggerAddress", "localhost:9225")
...
if __name__ == "__main__":
    print("Opening Session-4")
    command = r'"C:\Program Files\Google\Chrome\Application\chrome.exe" --remote-debugging-port=9225 --user-data-dir="C:/Chrome_Session4"'
    ...
    local_csv_path = r'C:\Users\Xcient\Desktop\scrapper\1_lac\final_lac_api\100k-leads\9225\temp.csv'  # Set the full path to the local CSV
