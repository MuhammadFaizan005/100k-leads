...
if __name__ == "__main__":
    print("Opening Session-3")
    command = r'"C:\Program Files\Google\Chrome\Application\chrome.exe" --remote-debugging-port=9224 --user-data-dir="C:/Chrome_Session3"'
    ...
    local_csv_path = r'C:\Users\Xcient\Desktop\scrapper\1_lac\final_lac_api\100k-leads\9224\temp.csv'  # Set the full path to the local CSV
